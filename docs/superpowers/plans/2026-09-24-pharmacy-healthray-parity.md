...
**P6 as built — patient messages (2026-09-26, lane `pharmacy-patient-messages`, migration 0138).** A bill by SMS and an
opt-in refill reminder, on the notify kernel's one outbox — no second messaging system. Runbook §18.
