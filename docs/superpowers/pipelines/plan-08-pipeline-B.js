export const meta = {
  name: 'plan-08-billing-pipeline-B',
  ...
  phases: [
    { title: 'Wave 1', detail: "T7 [CRITICAL/opus] Credit notes - cumulative partial-refund arithmetic, clearance discount, correction" },
    { title: 'Wave 2', detail: "T8 [CRITICAL/opus] Refund vouchers - the four guards, approval-gated always, refund-to-payer" },
    { title: 'Wave 3', detail: "T9 [CRITICAL/sonnet] Tender lifecycle, degraded mode, statement-upload reconciliation" },
    { title: 'Wave 4', detail: "T10 [CRITICAL/opus] Pay-before-consult gate (the only OPD edit), charge rules, daily close, GSTR-1" },
