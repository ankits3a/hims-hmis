...
import { PharmacyRetailController } from "./pharmacy-retail.controller";
 ...
 * retail counter.
 */
@Module({ controllers: [PharmacyItemsController, PharmacyCounterController, PharmacyPharmacistsController, PharmacyRetailController] })
