...
describe("the pharmacy manifest claims the medication order kind (16c T1)", () => {
  ...
  it("declares the four counter permissions, P2's register permission and P9's H1 register read, the Rx-issued subscription (T3), and the menu entries (T5, P2, P4, P9, P19, P20)", () => {
    ...
    expect(pharmacyManifest.menu.map((e) => e.path)).toEqual(["/pharmacy/counter", "/pharmacy/desk", "/pharmacy/items", "/pharmacy/pharmacists", "/pharmacy/reorder", "/pharmacy/registers/h1", "/pharmacy/leakage", "/pharmacy/retail", "/pharmacy/retail-licence", "/pharmacy/downtime"]);
